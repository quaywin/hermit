...
config :hermit, HermitWeb.Endpoint,
  ...
  https: [ip: {0, 0, 0, 0}, port: 3443],
  check_origin: false,
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "jTS4Lg70KNfRDxid6iwTCQRTawVa43r4qPkYiiTiEMBPbpzegdRI4zm48NJrCqQc",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:hermit, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:hermit, ~w(--watch)]}
  ]
