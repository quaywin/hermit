defmodule Hermit.Dns.PacketTest do
  ...
  test "extracts resolved IPv4 and IPv6 addresses from a response packet" do
    ...
    answer_a = <<0xC0, 0x0C, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2C, 0x00, 0x04, 142, 250, 190, 46>>

    # AAAA Record with 2001:db8::1 (2001:0db8:0000:0000:0000:0000:0000:0001)
    # RDATA length is 16 bytes
    # Type 28 (0x001C)
    answer_aaaa = <<0xC0, 0x0C, 0x00, 0x1C, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2C, 0x00, 0x10,
                    0x20, 0x01, 0x0D, 0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01>>

    # 1 Question, 2 Answers
    packet_bin = <<id::binary, 0x81, 0x80, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00>> <>
